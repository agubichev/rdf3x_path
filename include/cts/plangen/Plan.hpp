...
{
   /// Possible operators
   enum Op { IndexScan, AggregatedIndexScan, FullyAggregatedIndexScan, DijkstraScan, RegularPath, NestedLoopJoin, MergeJoin, HashJoin, HashGroupify, Filter, PathFilter, Union, MergeUnion, TableFunction, Singleton };
