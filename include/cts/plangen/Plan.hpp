...
{
   /// Possible operators
   enum Op { IndexScan, AggregatedIndexScan, FullyAggregatedIndexScan, DijkstraScan, NestedLoopJoin, MergeJoin, HashJoin, HashGroupify, Filter, PathFilter, Union, MergeUnion, TableFunction, Singleton };
